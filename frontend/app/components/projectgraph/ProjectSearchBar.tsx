    ...
    <div className="absolute top-4 left-1/2 -translate-x-1/2">
      <div className="relative">
        <input
          ...
          className="bg-zinc-800/90 text-zinc-200 text-sm rounded-lg pl-9 pr-8 py-2 w-72 placeholder:text-zinc-500 border border-zinc-700/50 focus:outline-none focus:border-zinc-500 transition-colors"
        />
        <svg
